...
- (void)sendAnalyticsData
{
    ...
    if (![defaults objectForKey:@"analyticsViewWorkoutsInDay"]) {
        [[[GAI sharedInstance] defaultTracker] trackView:@"View Workouts In Day"];
        [defaults setObject:[NSDate date] forKey:@"analyticsViewWorkoutsInDay"];
    }
    else {
        NSDate *analyticsLastPostDate = [defaults objectForKey:@"analyticsViewWorkoutsInDay"];
