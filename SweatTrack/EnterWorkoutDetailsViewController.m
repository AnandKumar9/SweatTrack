...
- (void)sendAnalyticsData
{
    ...
    if (![defaults objectForKey:@"analyticsSubmitWorkout"]) {
        [[[GAI sharedInstance] defaultTracker] trackView:@"Submit Workout"];
        [defaults setObject:[NSDate date] forKey:@"analyticsSubmitWorkout"];
    }
    else {
        NSDate *analyticsLastPostDate = [defaults objectForKey:@"analyticsSubmitWorkout"];
